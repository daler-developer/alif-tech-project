...
describe('helpers', () => {
  test('convertArrayToCommaSeperatedList()', () => {
    ...
    expect(convertArrayToCommaSeperatedList(['daler', 'aziz'])).toBe('daler, aziz')
  })
  ...
  test('removeDuplicatesFromArray()', () => {
    ...
    expect(removeDuplicatesFromArray(['daler', 'aziz', 12, 11, 11, 'aziz'])).toEqual(['daler', 'aziz', 12, 11])
  })

  test('formatFirebaseTimestamp()', () => {
    expect(formatFirebaseTimestamp(new Timestamp(100, 100))).toEqual('01:01:1970 06:01:40')
    expect(formatFirebaseTimestamp(new Timestamp(1000, 1000))).toEqual('01:01:1970 06:16:40')
  })
})
